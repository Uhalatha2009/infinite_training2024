    ...
    class Program
    {
        ...
        class AccountDetails
        {
            static void Main()
            {
                ...
                Accounts ac = new Accounts(accountNumber, customerName, accountType, transactionType, amount, 15000);

                //Accounts ac = new Accounts(123456, "latha", "Savings", 'D', 15000.00, 5000.00);
